...
sub = pd.read_csv("submission_surf_lr.csv")
...
sub = pd.read_csv("submission_surf_nb.csv")
y_pred = np.array(sub.pop('Label'))
y_test = np.array(sub.pop('TrueLabel'))
...
sub = pd.read_csv("submission_surf_svm.csv")
y_pred = np.array(sub.pop('Label'))
y_test = np.array(sub.pop('TrueLabel'))
...
sub = pd.read_csv("submission_surf_mlp.csv")
y_pred = np.array(sub.pop('Label'))
y_test = np.array(sub.pop('TrueLabel'))
